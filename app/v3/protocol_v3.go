...
// NewProtocolV3 protocol v3 constructor
func NewProtocolV3(version uint64, log log.Logger, pk sdk.ProtocolKeeper, checkInvariant bool, trackCoinFlow bool, config *cfg.InstrumentationConfig) *ProtocolV3 {
	p3 := ProtocolV3{
		version:        version,
		logger:         log,
		protocolKeeper: pk,
...
func (p *ProtocolV3) Init(ctx sdk.Context) {
	...
	p.serviceKeeper.Init(ctx, rand.GetSvcDefinitions())
}

// GetCodec get codec
func (p *ProtocolV3) GetCodec() *codec.Codec {
	return p.cdc
}
...
func (p *ProtocolV3) GetVersion() uint64 {
	return p.version
}

// ValidateTx validate txs
func (p *ProtocolV3) ValidateTx(ctx sdk.Context, txBytes []byte, msgs []sdk.Msg) sdk.Error {
...
// create all Keepers
func (p *ProtocolV3) configKeepers() {
...
func (p *ProtocolV3) configRouters() {
	p.router.
...
func (p *ProtocolV3) configFeeHandlers() {
...
func (p *ProtocolV3) GetKVStoreKeyList() []*sdk.KVStoreKey {
...
func (p *ProtocolV3) configParams() {
...
func (p *ProtocolV3) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
...
func (p *ProtocolV3) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
...
func (p *ProtocolV3) InitChainer(ctx sdk.Context, DeliverTx sdk.DeliverTx, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (p *ProtocolV3) GetRouter() protocol.Router {
	return p.router
}
func (p *ProtocolV3) GetQueryRouter() protocol.QueryRouter {
	return p.queryRouter
}
func (p *ProtocolV3) GetAnteHandlers() []sdk.AnteHandler {
	return p.anteHandlers
}
func (p *ProtocolV3) GetFeeRefundHandler() sdk.FeeRefundHandler {
	return p.feeRefundHandler
}
func (p *ProtocolV3) GetFeePreprocessHandler() sdk.FeePreprocessHandler {
	return p.feePreprocessHandler
}
func (p *ProtocolV3) GetInitChainer() sdk.InitChainer1 {
	return p.InitChainer
}
func (p *ProtocolV3) GetBeginBlocker() sdk.BeginBlocker {
	return p.BeginBlocker
}
func (p *ProtocolV3) GetEndBlocker() sdk.EndBlocker {
	return p.EndBlocker
}
