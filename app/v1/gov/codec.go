...
func RegisterCodec(cdc *codec.Codec) {
	...
	cdc.RegisterConcrete(MsgSubmitAddAssetProposal{}, "irishub/gov/MsgSubmitAddAssetProposal", nil)
	...
	cdc.RegisterConcrete(&AddAssetProposal{}, "irishub/gov/AddAssetProposal", nil)
