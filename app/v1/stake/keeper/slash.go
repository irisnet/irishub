...
func (k Keeper) Slash(ctx sdk.Context, consAddr sdk.ConsAddress, infractionHeight int64, power int64, slashFactor sdk.Dec) (tags sdk.Tags) {
	...
	if err == nil {
		k.metrics.SlashedToken.With("validator_address", validator.GetOperator().String()).Add(slashToken)
	}
...
func (k Keeper) Unjail(ctx sdk.Context, consAddr sdk.ConsAddress) {
	...
	k.metrics.Jailed.With("validator_address", validator.GetOperator().String()).Set(0)
	// TODO Return event(s), blocked on https://github.com/tendermint/tendermint/pull/1803
	return
}
