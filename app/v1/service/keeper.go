...
func (k Keeper) AddServiceBinding(ctx sdk.Context, svcBinding SvcBinding) sdk.Error {
	...
	_, err = k.ck.SendCoins(ctx, svcBinding.Provider, bank.ServiceDepositCoinsAccAddr, svcBinding.Deposit)
	if err != nil {
		return err
	}
...
func (k Keeper) Enable(ctx sdk.Context, defChainID, defName, bindChainID string, provider sdk.AccAddress, deposit sdk.Coins) sdk.Error {
	...
	// Subtract coins from provider's account
	_, err = k.ck.SendCoins(ctx, binding.Provider, bank.ServiceDepositCoinsAccAddr, deposit)
	if err != nil {
		return err
	}
...
func (k Keeper) RefundDeposit(ctx sdk.Context, defChainID, defName, bindChainID string, provider sdk.AccAddress) sdk.Error {
	...
	_, err := k.ck.SendCoins(ctx, bank.ServiceDepositCoinsAccAddr, binding.Provider, binding.Deposit)
	if err != nil {
		return err
	}
...
func (k Keeper) AddRequest(ctx sdk.Context, req SvcRequest) (SvcRequest, sdk.Error) {
	...
	_, err := k.ck.SendCoins(ctx, req.Consumer, bank.ServiceRequestCoinsAccAddr, req.ServiceFee)
	if err != nil {
		return req, err
	}
...
func (k Keeper) RefundFee(ctx sdk.Context, address sdk.AccAddress) sdk.Error {
	...
	_, err := k.ck.SendCoins(ctx, bank.ServiceRequestCoinsAccAddr, address, fee.Coins)
	if err != nil {
		return err
	}
...
func (k Keeper) AddIncomingFee(ctx sdk.Context, address sdk.AccAddress, coins sdk.Coins) sdk.Error {
	...
	_, err := k.ck.SendCoins(ctx, bank.ServiceRequestCoinsAccAddr, bank.ServiceTaxCoinsAccAddr, taxCoins)
	if err != nil {
		return err
	}
