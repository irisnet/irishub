	...
	tests := []struct {
		...
		{"Minimum value",
			Params{
				...
				IssueTokenBaseFee:    sdk.NewCoin(sdk.NativeTokenMinDenom, sdk.ZeroInt()),
				CreateGatewayBaseFee: sdk.NewCoin(sdk.NativeTokenMinDenom, sdk.ZeroInt()),
			},
			true,
		},
		{"Maximum value",
			Params{
				...
				IssueTokenBaseFee:    sdk.NewCoin(sdk.NativeTokenMinDenom, sdk.NewInt(math.MaxInt64)),
				CreateGatewayBaseFee: sdk.NewCoin(sdk.NativeTokenMinDenom, sdk.NewInt(math.MaxInt64)),
			},
			true,
		},
		{"AssetTaxRate less than the maximum",
			Params{
				...
				IssueTokenBaseFee:    sdk.NewCoin(sdk.NativeTokenMinDenom, sdk.NewInt(1)),
				CreateGatewayBaseFee: sdk.NewCoin(sdk.NativeTokenMinDenom, sdk.NewInt(1)),
			},
			false,
		},
		...
		{"IssueTokenBaseFee is negative",
			Params{
				...
				MintTokenFeeRatio:    sdk.NewDec(1),
				GatewayAssetFeeRatio: sdk.NewDec(1),
				IssueTokenBaseFee:    sdk.Coin{Denom: sdk.NativeTokenMinDenom, Amount: sdk.NewInt(-1)},
				CreateGatewayBaseFee: sdk.Coin{Denom: sdk.NativeTokenMinDenom, Amount: sdk.NewInt(1)},
			},
			false,
		},
