...
func NewIrisApp(logger log.Logger, dbs map[string]dbm.DB) *IrisApp {
	...
	app.MountStoreWithDB(app.capKeyIrisStore, sdk.StoreTypeIAVL, dbs["iservice"])
...
func (app *IrisApp) txDecoder(txBytes []byte) (sdk.Tx, sdk.Error) {
	var tx = sdk.StdTx{}
...
func (app *IrisApp) initChainerFn(coolKeeper cool.Keeper, powKeeper pow.Keeper) sdk.InitChainer {
