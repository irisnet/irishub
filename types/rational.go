...
//nolint
func (r Rat) Num() sdk.Int            { return sdk.Int{r.Rat.Num()} }   // Num - return the numerator
func (r Rat) Denom() sdk.Int          { return sdk.Int{r.Rat.Denom()} } // Denom  - return the denominator
