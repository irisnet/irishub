...
func (r Rat) FloatString() string { return r.Rat.FloatString(28) } // a human-friendly string format. The last digit is rounded to nearest, with halves rounded away from zero.
