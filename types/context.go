...
func (c Context) CoinFlowTrigger() string {
	return c.tagsManager.GetCoinFlowTrigger()
}
...
func NewContext(ms MultiStore, header abci.Header, isCheckTx bool, logger log.Logger) Context {
	...
	return Context{
		...
		minimumFee:     Coins{},
		tagsManager:    NewTagsManager(false),
...
func (c Context) WithTagsManager(tm *TagsManager) Context {
	c.tagsManager = tm
	return c
}
...
func (c Context) WithCoinFlowTrigger(coinFlowTrigger string) Context {
	...
	return c.WithTagsManager(newTagsManager)
}
