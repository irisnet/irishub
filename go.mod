...
require (
	...
	github.com/irisnet/irismod v1.5.3-0.20220413081635-5f27ce3a75f7
...
replace github.com/tendermint/tendermint => github.com/bianjieai/tendermint v0.33.1-dev0.0.20220413093044-902a4a7d5817
