...
func TestMsgRequestRandomGetSignBytes(t *testing.T) {
	...
	expected := fmt.Sprintf("{\"type\":\"irishub/rand/MsgRequestRandom\",\"value\":{\"block_interval\":\"10\",\"consumer\":\"cosmos1w3jhxazpv3j8y5jww2c\",\"oracle\":true,\"service_fee_cap\":[{\"amount\":\"1000000000000000000\",\"denom\":\"%s\"}]}}", sdk.DefaultBondDenom)
