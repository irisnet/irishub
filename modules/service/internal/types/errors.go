...
var (
	...
	ErrInvalidIDL               = sdkerrors.Register(ModuleName, 4, "the IDL content cannot be parsed")
	ErrInvalidOutputPrivacyEnum = sdkerrors.Register(ModuleName, 5, "invalid OutputPrivacyEnum")
	ErrInvalidOutputCachedEnum  = sdkerrors.Register(ModuleName, 6, "invalid OutputCachedEnum")
	...
	ErrInvalidPriceCount        = sdkerrors.Register(ModuleName, 9, "prices count must be equal to methods count")
