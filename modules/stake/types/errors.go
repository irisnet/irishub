...
func ErrCommissionMaxRateHuge(codespace sdk.CodespaceType) sdk.Error {
	return sdk.NewError(codespace, CodeInvalidValidator, "commission max rate cannot be more than 100%")
}

func ErrCommissionMaxChangeRateHuge(codespace sdk.CodespaceType) sdk.Error {
	return sdk.NewError(codespace, CodeInvalidValidator, "commission max change rate cannot be more than 100%")
}
