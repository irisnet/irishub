...
func (k Keeper) Delegate(ctx sdk.Context, delAddr sdk.AccAddress, bondAmt sdk.Coin,
	...
	if subtractAccount {
		...
		ctx.CoinFlowTags().AppendCoinFlowTag(ctx, delAddr.String(), validator.OperatorAddr.String(),  bondAmt.String(), sdk.TokenTransfer)
...
func (k Keeper) BeginUnbonding(ctx sdk.Context,
	...
	// TODO quick fix, instead we should use an index, see https://github.com/irisnet/irishub/issues/1402
...
func (k Keeper) CompleteUnbonding(ctx sdk.Context, delAddr sdk.AccAddress, valAddr sdk.ValAddress) sdk.Error {
	...
	if !ubd.Balance.IsZero() {
		ctx.CoinFlowTags().AppendCoinFlowTag(ctx, valAddr.String(), ubd.DelegatorAddr.String(),  ubd.Balance.String(), sdk.StakeDelegationRefund)
	}
