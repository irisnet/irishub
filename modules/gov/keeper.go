...
func (keeper Keeper) AddDeposit(ctx sdk.Context, proposalID uint64, depositorAddr sdk.AccAddress, depositAmount sdk.Coins) (sdk.Error, bool) {
	...
	ctx.CoinFlowTags().AppendAddCoinSourceTag(ctx.CoinFlowTrigger(), DepositedCoinsAccAddr.String(), ctx.CoinFlowMsgType(), sdk.GovDeposit, depositorAddr.String(), depositAmount.String(), ctx.BlockHeader().Time.String())
...
func (keeper Keeper) RefundDeposits(ctx sdk.Context, proposalID uint64) {
	...
	for _, deposit := range deposits {
		...
		ctx.CoinFlowTags().AppendAddCoinSourceTag(ctx.CoinFlowTrigger(), deposit.Depositor.String(), ctx.CoinFlowMsgType(), sdk.GovDepositRefund, DepositedCoinsAccAddr.String(), deposit.Amount.String(), ctx.BlockHeader().Time.String())
