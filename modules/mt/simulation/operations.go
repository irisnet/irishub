...
func SimulateMsgIssueDenom(
	...
	return func(
		...
		txCfg := moduletestutil.MakeTestEncodingConfig().TxConfig
	...
	return func(
		...
		if amt <= 1 {
			return simtypes.NoOpMsg(
				mt.ModuleName,
				mt.EventTypeTransfer,
				"sender doesn't have enough mt balances ",
			), nil, nil
		}
