...
func NewBaseToken(family AssetFamily, source AssetSource, gateway string, symbol string, name string,
...
func NewFungibleToken(source AssetSource, gateway string, symbol string, name string, decimal uint8,
