...
//	msgIssueNativeToken := types.MsgIssueToken{Symbol: types.AssetSource(0x00), Symbol: "sym"}
//	msgIssueGatewayToken := types.MsgIssueToken{Symbol: types.AssetSource(0x02), Symbol: "sym"}
