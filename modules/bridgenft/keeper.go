...
// NewBridgeNftKeeper creates a new ics721 Keeper instance
func NewBridgeNftKeeper(cdc codec.Codec,
...
func (ik InterNftKeeper) GetClass(ctx sdk.Context, classID string) (convertertypes.Class, bool) {
...
func (ik InterNftKeeper) GetNFT(ctx sdk.Context, classID, tokenID string) (convertertypes.NFT, bool) {
...
func (ik InterNftKeeper) SaveClass(ctx sdk.Context, classID, classURI string, classData string) error {
	return ik.CreateOrUpdateClass(ctx, classID, classURI, classData)
}
