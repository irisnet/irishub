...
func (suite *TestSuite) TestKeeperSwap() {
...
func createReservePool(suite *TestSuite) (sdk.AccAddress, sdk.AccAddress, sdk.Error, sdk.Coins, sdk.Coins) {
...
func ifNil(suite *TestSuite, err sdk.Error) {
	msg := ""
	if err != nil {
		msg = err.Error()
	}
