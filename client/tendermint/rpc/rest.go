...
func RegisterRoutes(cliCtx context.CLIContext, r *mux.Router, cdc *codec.Codec) {
	...
	r.HandleFunc("/block-result/latest", LatestBlockResultRequestHandlerFn(cliCtx)).Methods("GET")
	r.HandleFunc("/block-result/{height}", BlockResultRequestHandlerFn(cliCtx)).Methods("GET")
