...
在这个例子中执行的是完成解绑操作，这里设定的交易费上限(--fee)为0.12iris，Gas上限(--gas)为20000，Gas价格就是 6000iris-nano/Gas。假设执行交易总共需要10000个Gas，那么会有 1200iris-atto 的交易费被支付给验证人节点；剩余的 0.11999iris 会被退还给用户。
