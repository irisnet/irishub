...
```  
iriscli bank send --to=faa19aamjx3xszzxgqhrh0yqd4hkurkea7f6d429yx  --from=test  --fee=0.4iris --chain-id=irishub-test --amount=10iris --generate-only
...
```
iriscli bank send --to=faa19aamjx3xszzxgqhrh0yqd4hkurkea7f6d429yx  --from=test  --fee=0.4iris --chain-id=irishub-test --amount=10iris --generate-only > tx.json
```
