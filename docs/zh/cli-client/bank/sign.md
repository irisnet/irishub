...
```  
iriscli bank send --to=iaa19aamjx3xszzxgqhrh0yqd4hkurkea7f6d429yx  --from=test  --fee=0.3iris --chain-id=<chain-id> --amount=10iris --generate-only
...
```
iriscli bank send --to=iaa19aamjx3xszzxgqhrh0yqd4hkurkea7f6d429yx  --from=test  --fee=0.3iris --chain-id=<chain-id> --amount=10iris --generate-only > tx.json
```
