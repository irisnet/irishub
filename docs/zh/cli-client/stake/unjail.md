...
```$xslt
iriscli stake signing-info icp1zcjduepqewwc93xwvt0ym6prxx9ppfzeufs33flkcpu23n5eutjgnnqmgazsw54sfv --node=localhost:36657 --trust-node
```
...
```
iriscli stake unjail --from=<key name> --fee=0.3iris --chain-id=<chain-id>-irishub
```
