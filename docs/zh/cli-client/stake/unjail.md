...
在PoS网络中，验证人的收益主要来自于staking抵押获利，但是若他不能保持在线，就会被当作一种作恶行为。系统会剥夺他作为验证人参与共识的资格。这样一来，他的状态会变成jailed，他的投票权将立刻变为零。这种状态将持续一段时间。当jailed期结束，验证人节点的operator需要执行 unjail操作来让节点的状态变为unjailed，再次成为验证人或者候选验证人。
