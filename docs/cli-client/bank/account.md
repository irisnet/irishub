...
```
 iriscli bank account iaa19aamjx3xszzxgqhrh0yqd4hkurkea7f6d429yx --trust-node=true
```
...
```
iriscli bank account iaa19aamjx3xszzxgqhrh0yqd4hkurkea7f6d429yx --chain-id=<chain-id>
```
