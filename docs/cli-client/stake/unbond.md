...
## Examples
If you want to unbond 10shares:
```
iriscli stake unbond --address-validator=<ValidatorAddress> --shares-amount=10 --from=<key name> --chain-id=<chain-id> --fee=0.3iris
```

If you want to unbond 10% of your share:
```
